...
namespace HoloPlaySDK
{
    ...
    public class HoloPlay : MonoBehaviour
    {
        ...
        /// </summary>
        public static readonly float version = 0.393f;
        ...
        public readonly float quitTime = 2f;
        ...
        void OnEnable()
        {
            ...
            string[] comArgs = System.Environment.GetCommandLineArgs();
        ...
        void OnGUI()
        {
            if (quitting)
            {
                if (!quitToLauncher || !HoloPlayLauncher.Instance.currentlyQuittingToLauncher)
                {
                    ...
                    // GUI.Box(imguiRect, "quitting in " + quitTimer.ToString("0.0"));
                }
            }
